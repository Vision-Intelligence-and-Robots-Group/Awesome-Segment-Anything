...
def get_daily_papers(topic,query="SAM", max_results=10):
    """
    @param topic: str
    @param query: str
...
if __name__ == "__main__":
    ...
    keywords = dict()
    keywords["SAM"]              = "ti:%22segment anything%22 OR abs:%22segment anything%22"
    # keywords["WiFi HAR"]                  = "\"action recognition\"OR\"gesture recognition\"AND\"wifi\""
